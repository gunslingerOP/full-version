    ...
    <Row>
      <Col md='6' sm='12'>
        <div className='p-3 bg-primary my-2 rounded'>
          <Toast>
            <ToastHeader close={close}>Guevara</ToastHeader>
            <ToastBody>
...
const ToastHeaderIcons = () => {
  return (
    <Row>
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='primary'>Guevara</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='success'>Guevara</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='info'>Guevara</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='danger'>Guevara</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='warning'>Guevara</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
          <ToastHeader close={close} icon='dark'>Guevara</ToastHeader>
          <ToastBody>
      ...
      <Col md='6' sm='12'>
        <Toast>
        <ToastHeader close={close} icon={logo}>Guevara</ToastHeader>
